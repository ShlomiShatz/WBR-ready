...
Here, we will see how to add a new node to the project, used to control the robot with the keyboard. We will add the node to the *src/node_examples* directory.  
